...
@section('content')
    <h2>{{ $title }}:</h2>
    <div class="d-grid">
        <a href="{{ route('type.create') }}" class="btn btn-primary">Create New Type</a>
    </div>
    @if (session('status'))
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-body d-grid gap-1">
                                    <div class="d-flex gap-2 flex-fill">
                                        <a href="{{ route('type.edit', $item->id) }}" class="btn btn-primary"
...
@section('script')
    ...
    <script>
        ...
        console.log(
            $('a span:contains("Type")').parent().parent().addClass("active"))
